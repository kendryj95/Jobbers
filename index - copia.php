					...
					<div class="col-md-3">
						...
						<div class="box bg-white">
							...
							<div class="card-block">
								<button class="btn btn-primary btn-block" onclick="applyFilter();">Aplicar filtro</button>
							</div>
						</div>
					</div>
											...
											<div class="t-content"  title="Ver detalles del empleo">
												<div class="row">
													...
													<div class="col-md-8 col-sm-8">
														...
														<h6 style="color: #373a3c; width: 90%;"><?php echo strlen($publicacion["titulo"]) > 40 ? ( '<span style="color: #373a3c;">'.substr($publicacion["titulo"], 0, 40).'</span>'.' <a href="empleos-detalle.php?a='.$publicacion["area_amigable"].'&s='.$publicacion["sector_amigable"].'&p='.$publicacion["amigable"].'">...</a>') : $publicacion["titulo"]; ?></h6>
