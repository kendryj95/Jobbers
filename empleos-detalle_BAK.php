								...
								<div class="box-block">
									<div class="pv-content" style="margin-bottom: 0px;">
										...
										<div class="pv-title" style="padding-right: 130px;">
											...
											<?php endif ?>
											<div id="socialLinks">
												<?php if($publicacion["link_empresa"] == 1): ?>
													<?php if($publicacion["sitio_web"] != ""): ?>
														<button type="button" class="btn bg-primary label-left m-b-0-25 waves-effect waves-light" data-url="<?php echo $publicacion["sitio_web"]; ?>">
															<span class="btn-label"><i class="ti-unlink"></i></span>
															<?php echo $publicacion["sitio_web"]; ?>
														</button>
													<?php endif ?>
												<?php endif ?>
												<?php if($publicacion["facebook"] != ""): ?>
													<button type="button" class="btn bg-facebook m-b-0-25 waves-effect waves-light" data-url="<?php echo $publicacion["facebook"]; ?>">
														<i class="ti-facebook m-r-0-25"></i> Facebook
													</button>
												<?php endif ?>
												<?php if($publicacion["twitter"] != ""): ?>
												<button type="button" class="btn bg-twitter m-b-0-25 waves-effect waves-light" data-url="<?php echo $publicacion["twitter"]; ?>">
													<i class="ti-twitter m-r-0-25"></i> Twitter
												</button>
												<?php endif ?>
												<?php if($publicacion["instagram"] != ""): ?>
												<button type="button" class="btn bg-instagram m-b-0-25 waves-effect waves-light" data-url="<?php echo $publicacion["instagram"]; ?>">
													<i class="ti-instagram m-r-0-25"></i> Instagram
												<?php endif ?></button>
