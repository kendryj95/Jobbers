							...
							<div class="col-md-12">
								...
								<div class="box bg-white">
									  <div class="col-xs-12" style="padding: 0px">
									  	...
									  	<button style="float: right;width: 20%;padding-left: 4px;border-radius: 5%; background-color:#2E3192; border-color:#2E3192; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" class="btn btn-primary" onClick="listar_publicaciones(0)">Buscar</button>
			  ...
			  $.ajax({
			  	...
			  	publicacion="";
					$.each( datos, function( key, value ) {
						...
						url="empleos-detalle.php?a="+datos[key]["area"]+"&s="+datos[key]["sector"]+"&p="+datos[key]["publicacion"]+"&e="+datos[key]["id_empresa"];
					...
					publicacion='<div class="col-sm-6" style="padding-right: 10px; padding-left: 10px;"><div class="victor_publicacion height-fix '+borde+minHeightFree+'" style="margin-bottom: 10px; padding-right: 10px; padding-left: 10px; overflow: auto;"> <div class="col-sm-12 text-center logo-medal '+paddingEmpresas+paddingEmpresasFree+' " style="'+socialNone+'">'+medalla+' <div class="col-md-6">  <img src="'+datos[key]["imagen_empresa"]+'" style=" '+widthImg+' "></br><span style="font-size:10px;">'+datos[key]["provincia"]+" - "+datos[key]["localidad"]+'</span></div> <div class="col-md-6"> <a class="link-pub-main" href="empresa/perfil.php?e='+urlEmp+'"><strong>'+urlEmpresa+verificado+'</strong></a> <p> <span style="font-size: 11px;"><strong>'+dias+'</strong></span><br> <a class="link-pub-sec" href="'+url+'">'+datos[key]["titulo_publicacion"]+'<div>'+facebook+link+twitter+instagram+'</div> </a> </p> <p style="font-size: 12px;" class="text-justify"> </p></div> </div><div class="col-sm-12 text-center" style="border-top: 1px solid #e5e5e5;padding: 0px;padding-top: 10px;padding-bottom: 8px;"> <a target="_blank" href="'+url+'" class="btn btn-primary btn-see-pub">Ver</a> </br></div></div>';  
