										...
										<div class="col-md-8">
											...
											<div class="row">
												<div class="col-xs-4" style="text-align: right;">
													<label for="birthday" class="col-form-label">Fecha de nacimiento <span style="color: red;">*</span></label>
												</div>
												<div class="col-xs-8">
													<div class="input-group">
														<input class="form-control mydatepicker" placeholder="dd/mm/yyyy" value="<?php echo date('d/m/Y', strtotime($data["fecha_nacimiento"])); ?>" id="birthday" type="text">
											...
											<div class="row" style="margin-top: 10px;">
												...
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $data["provincia"]; ?>" id="province" type="text">
												</div>
											</div>
											<div class="row" style="margin-top: 10px;">
												<div class="col-md-4" style="text-align: right;">
												...
												<div class="col-md-8">
													<input class="form-control" value="<?php echo $data["localidad"]; ?>" id="city" type="text">
												</div>
											</div>
		...
		<script>
			$(document).ready(function(){
				...
				$(".save").click(function() {
					...
					switch(op) {
						case 1:
							if($("#name").val() != "" && $("#lastName").val() != "" && $("input[type=radio][name=sex]:checked").length > 0 && $("#birthday").val() != "" && parseInt($("#country").val()) > 0 && parseInt($("#dni").val()) > 0 && $("#numberdni").val() != "" && $("#province").val() != "" && $("#city").val() != "" && $("#street").val() != "" && $("#phone").val() != "") {
								str = '&name='+$("#name").val() + '&lastName='+$("#lastName").val() + '&sex='+$("input[type=radio][name=sex]:checked").val() + '&birthday='+$("#birthday").val() + '&country='+$("#country").val() + '&estadoCivil='+$("#estadoCivil").val() + '&dni='+$("#dni").val() + '&numberdni='+$("#numberdni").val() + '&province='+$("#province").val() + '&city='+$("#city").val() + '&street='+$("#street").val() + '&phone='+$("#phone").val() + '&phoneAlt='+$("#phoneAlt").val();
								band = true;
							}
							break;
						case 2:
