								...
								<div id="step2" style="display: none;">
									...
									<div class="row" style="margin-bottom: 15px;">
										<div class="col-md-4" style="margin-top:20px;">
											<div class="card price-card">
												<div class="card-header price-card-header bg-primary text-xs-center" style="width: 100%;height: 99px;">
													<h6 class="text-uppercase">Búsqueda de CV</h6>
													<h3 class="m-b-0">
														<sup>$</sup>
														<span class="text-big" style="font-size: 28px;"><?php echo $servicios[0]["precio"]; ?></span>
														<span class="text-small">/ mes</span>
													</h3>
												</div>
												<ul class="price-card-list p-l-0 m-b-0">
													<li>
														<i class="fa fa-check text-success m-r-0-25"></i> <span class="text-muted">40 CVs disponibles para descargar en un mes..</span>
													</li>
													<li>
												...
												<div class="card-footer">
													<a href="javascript:void(0)" class="btn btn-outline-primary btn-block btn-lg addService" data-target="1">Agregar</a>
												</div>
											</div>
										</div>
										<div class="col-md-4" style="margin-top: 20px;">
											<div class="card price-card">
												<div class="card-header price-card-header bg-primary text-xs-center" style="width: 100%;height: 99px;">
													<h6 class="text-uppercase">Búsqueda en base x 100</h6>
													<h3 class="m-b-0">
														<sup>$</sup>
														<span class="text-big" style="font-size: 28px;"><?php echo $servicios[1]["precio"]; ?></span>
														<span class="text-small">/ mes</span>
													</h3>
												</div>
												<ul class="price-card-list p-l-0 m-b-0">
													<li>
														<i class="fa fa-check text-success m-r-0-25"></i> <span class="text-muted">100 CVs disponibles para descargar en un mes.</span>
													</li>
													<li>
														<i class="fa fa-check text-success m-r-0-25"></i> <span class="text-muted"> Ideal para búsquedas de perfiles habituales.</span>
													</li>
													<li>
														<i class="fa fa-check text-success m-r-0-25"></i> <span class="text-muted">Filtros Personalizados.</span>
													</li>
												...
												<div class="card-footer">
													<a href="javascript:void(0)" class="btn btn-outline-primary btn-block btn-lg addService" data-target="2">Agregar</a>
												</div>
											</div>
										</div>
										<div class="col-md-4" style="margin-top: 20px;">
											<div class="card price-card">
												<div class="card-header price-card-header bg-primary text-xs-center" style="width: 100%;height: 99px;">
													<h6 class="text-uppercase">Búsqueda en base x 150</h6>
													<h3 class="m-b-0">
														<sup>$</sup>
														<span class="text-big" style="font-size: 28px;"><?php echo $servicios[2]["precio"]; ?></span>
														<span class="text-small">/ mes</span>
													</h3>
												</div>
												<ul class="price-card-list p-l-0 m-b-0">
													<li>
														<i class="fa fa-check text-success m-r-0-25"></i> <span class="text-muted">150 CVs disponibles para descargar en un mes.</span>
													</li>
													<li>
												...
												<div class="card-footer">
													<a href="javascript:void(0)" class="btn btn-outline-primary btn-block btn-lg addService" data-target="3">Agregar</a>
												</div>
											</div>
										</div>
									</div>
